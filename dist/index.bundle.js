...
eval("\n\nmodule.exports = function (url, options) {\n  if (!options) {\n    options = {};\n  }\n\n  if (!url) {\n    return url;\n  }\n\n  url = String(url.__esModule ? url.default : url); // If url is already wrapped in quotes, remove them\n\n  if (/^['\"].*['\"]$/.test(url)) {\n    url = url.slice(1, -1);\n  }\n\n  if (options.hash) {\n    url += options.hash;\n  } // Should url be wrapped?\n  // See https://drafts.csswg.org/css-values-3/#urls\n\n\n  if (/[\"'() \\t\\n]|(%20)/.test(url) || options.needQuotes) {\n    return \"\\\"\".concat(url.replace(/\"/g, '\\\\\"').replace(/\\n/g, \"\\\\n\"), \"\\\"\");\n  }\n\n  return url;\n};\n\n//# sourceURL=webpack://tower-of-hanoi/./node_modules/css-loader/dist/runtime/getUrl.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n/* harmony import */ var _handling_dom_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./handling-dom.js */ \"./src/handling-dom.js\");\nconsole.log('Tower of Hanoi is running.');\r\n\r\n\r\n\r\n\r\nconst log = console.log;\r\nconst body = document.body;\r\n// log(body);\r\n\r\nconst cont = (0,_handling_dom_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"])('div', ['container'], '', '', body);\r\n(0,_handling_dom_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"])('div', ['label'], '', 'UNDER CONSTRUCTION', cont);\r\n(0,_handling_dom_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"])('div', ['link'], '', '<a href=\"test.html\">TEST</a>', cont);\n\n//# sourceURL=webpack://tower-of-hanoi/./src/index.js?");
...
eval("module.exports = __webpack_require__.p + \"f08794a84b8d4a9f809f.png\";\n\n//# sourceURL=webpack://tower-of-hanoi/./img/tower-0.png?");
